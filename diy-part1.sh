...
wget https://github.com/garypang13/openwrt-packages/tree/master/lua-maxminddb  package/lua-maxminddb
wget https://github.com/garypang13/smartdns-le package/smartdns-le
